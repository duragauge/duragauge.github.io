...
{{% /answer %}}
1. Write the series for the sequence $5, \thinspace 10, \thinspace 15, \thinspace 20, \thinspace 25$.
...
{{% /answer %}}
1. Find the sum of the arithmetic series $\ 32,\ 36,\ 40,\ \dots,\ 80 \thinspace $.
{{% answer %}}
<div>
...
{{% check %}}
1. Write Gauss's series $ \thinspace 1 + 2 + 3 + \cdots + 100 \thinspace $ in summation notation.
{{% answer %}}
\[\sum\_{n=1}^{100} n\]
{{% /answer %}}
