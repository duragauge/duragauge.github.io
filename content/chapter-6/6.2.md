...
Throughout this text, a model will consist of a function along with a description of the variables and their units of measure.  Without an accurate description, the function itself is meaningless since there would be no way to relate it to the real world.
