...
Notice that when the denominator $\color{green}{m}$ is odd, the function displays even symmetry if the numerator $\color{blue}{n}$ is even and odd symmetry if the numerator $\color{blue}{n}$ is odd.
