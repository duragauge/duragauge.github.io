...
In this section, we will find an underlying structure that unifies the [six basic functions from Chapter 1](//chapter-1/1.3) and opens up a new category of functions for our use.
