...
\[
  d =  \frac{0.03661(60)^{2}}{0.2}  \approx 605 \text{ feet}
\]

So if you were travelling at 60mph down a snow covered road, it would take about 605 feet for your car to stop once you had applied the brakes.

{{% check %}}
Suppose you were driving under the same conditions at a much safer speed of $30$ mph.  What would the stopping distance be? {{% answer %}}With $\mu=0.2$ and $v=30$ mph, we have \[ d =  \frac{0.0336144(30)^2}{0.2}  \approx  151.25 \text{ feet} \] {{% /answer %}}
{{% /check %}}
