...
{{% answer %}}Since the degree is an odd number, and the leading coefficient is negative, the left end of the graph will point up while the right end points down.{{% /answer %}}   
{{% /check %}}
