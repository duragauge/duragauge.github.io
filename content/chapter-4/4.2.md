...
1. If the domain of $f$ is $[-10, 6)$ and the domain of $g$ is $(4, 9]$, what is the domain of $fg$? {{% answer %}}$[-10, 6) nn (4, 9] = (4, 6)$ so the domain of $fg$ is $(4, 6)$.  In other words, only the numbers between 4 and 6.{{% /answer %}}
{{% /check %}}
