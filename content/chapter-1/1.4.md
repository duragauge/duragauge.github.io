...
When functions are composed of several operations, there are two methods for finding the inverse, if it exists.  In [Chapter 4](/chapter-4/4.4#learn-the-switch-and-solve-method) you will learn a **switch and solve** method based on the idea of reversing the ordered pairs of a function.
