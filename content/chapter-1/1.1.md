...
The Sumerian system did not look like the one we use today.  They counted using groups of 60 (which is why we have 60 minutes in an hour) and different symbols than what we are used to.

The numbers we use today originated in India and were later adapted by Arab scholars. Because of it's origins our number system is called the Hindu-Arabic system.
