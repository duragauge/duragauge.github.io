...
## Looking Ahead
Transformations will be helpful when we model data in [Section 1.7](../1.7).  If a data set looks like a line, for example, then we can apply shifts and stretches to the identity function $f(x)=x$ until we find a combination that fits the shape of the data.
