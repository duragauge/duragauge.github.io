...
In the previous section we showed how the equation of a function can be used to create a table of values that can be plotted to create a graph.  While knowing how to do that by hand is a useful skill, the technology available to day makes exploring graphs of functions much simpler.
