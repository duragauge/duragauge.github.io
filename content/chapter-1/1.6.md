...
1.  Find the percentage change in $f$ over the interval $[1, 3]$. {{% answer %}}$\frac{f(b)-f(a)}{f(a)}=\frac{f(3)-f(1)}{f(1)}=\frac{-4-2}{2}=-3$ </br></br> which we interpret as a $300\%$ decrease.{{% /answer %}}
{{% /check %}}
