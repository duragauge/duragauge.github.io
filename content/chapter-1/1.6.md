...
Later that day, the SEC announced they were investiging Enron for accounting irregularities.  Within weeks the company declared bankruptcy and several Enron executives were sent to prison for fraud and conspiracy.
...
## Looking Ahead
We have just seen that the difference quotient helps us identify function behaviors such as concavity and intervals where the function is increasing or decreasing.  As we introduce new functions in the next chapters, you will that that functions with similar behaviors have similar difference quotients.  

We will also use the difference quotient to efficiently compute *average* rates of change. Additionally, if you continue on to calculus, you will learn that the difference quotient is used to calculate *instantaneous* rates change and is the foundation of the **derivative**, one of the most important concepts in calculus.
