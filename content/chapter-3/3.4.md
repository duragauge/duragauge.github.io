...
{{% geogebra ratio="45%" id_1="RgHW05KRAl4IrnaC" id_2="IGKPQXuw" id_m="IGKPQXuw" %}}

{{% answer %}}No, the linear-log plot is not linear, so the data is not exponential.{{% /answer %}}
<br>

{{% geogebra ratio="45%" id_1="mmKUmUSnjYQ8hDaJ" id_2="KGC8oRx9" id_m="KGC8oRx9" %}}
...
{{% geogebra ratio="45%" id_1="VVRNu7SNzVTjondO" id_2="AFzzMiyd" id_m="AFzzMiyd" %}}

{{% answer %}}Yes, the log-linear plot is linear, so the data is logarithmic.{{% /answer %}}
<br>

{{% geogebra ratio="45%" id_1="OhI43u2QGvoFoisg" id_2="T1QltySg" id_m="T1QltySg" %}}
...
{{% geogebra ratio="45%" id_1="CR827n5aZ8zJw2AD" id_2="WqQQ2Yh6" id_m="WqQQ2Yh6" %}}

{{% answer %}}Since the log-log plot is linear, this data can be modeled by a power function.{{% /answer %}}

{{% geogebra ratio="45%" id_1="WOaW1TWftQ1qx0oF" id_2="M5zGov2j" id_m="M5zGov2j" %}}
